...
def projected_reorder_point(daily_demand, lead_time_days, safety_stock):
...
def reorder_point_for(sku: Sku):
    return projected_reorder_point(sku.daily_demand, sku.lead_time_days, sku.safety_stock)
